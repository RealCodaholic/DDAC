...
namespace DDAC.Controllers
{
    ...
    public class ContainersController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Create([Bind(Include = "ContainerID,TotalLoad")] Container container)
        {
        ...
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        public ActionResult Edit([Bind(Include = "ContainerID,TotalLoad")] Container container)
        {
            if (ModelState.IsValid)
            {
